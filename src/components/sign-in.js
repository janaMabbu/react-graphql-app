      ...
      <div className="container">
       { this.props.isTokenFailure && <div className="alert alert-danger">
        ...
        <div className= { 'col-sm-12 ' + center_box }>
          <a href="https://github.com/login/oauth/authorize?client_id=13f8dbc254ebd4fc3311&scope=public_repo" type="button" className= { 'btn btn-primary btn-lg btn-block ' + center_btn } >GIT SignIn</a>
        </div>
      </div>
    )
  }
